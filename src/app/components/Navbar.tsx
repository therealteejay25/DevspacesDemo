...
const DEFAULT_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    ariaLabel: "About",
    rotation: 8,
    hoverStyles: { bgColor: "#22D3EE", textColor: "#ffffff" },
  },
  {
    label: "community",
    href: "#",
      ...
      >
        <div
          className={[
            ...
            "rounded-full",
            "bg-white dark:bg-gray-800 dark:text-white text-black",
        ...
        >
          <span
            className={[
              "logo-content",
              "inline-flex items-center text-black text-2xl justify-center",
              "w-[120px] h-full",
            ].join(" ")}
            style={
              {
